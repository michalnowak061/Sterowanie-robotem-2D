...
namespace PzG {
 ...
 {
  int Ilosc = (int)strlen(Komunikat);
  int IloscPrzeslanych;
  
  while (((IloscPrzeslanych = (int)write(_Wejscie_GNUPlota,Komunikat,Ilosc)) != -1)
          && Ilosc > 0) {
 ...
 { 
   ...
   UstawZakresX(-100,100);
   UstawZakresY(-100,100);
   UstawZakresZ(-100,100);
